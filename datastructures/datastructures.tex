...
\begin{algorithm}{Iterative Segment Tree}
	\begin{methods}
		...
		\method{query}{findet das agg in [l, r)}{\log(n)}
	...
	Left to right:\\
	\tab smallest kex in [l, rex] such that p(agg([l, kex))), or -1 if impossible\\
	\tab p should be increasing, i.e.  p(a1) <= p(agg(a1, a2))\\
	Right to left:\\
	\tab largest k in [l, rex] such that p(agg([k, rex))), or -1 if impossible\\
