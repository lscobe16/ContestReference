...
\begin{algorithm}{Union-Find}
	\begin{methods}
		...
		\method{find}{findet den Repräsentanten}{\alpha(n)}
		\method{unite}{vereint 2 Mengen}{1}
		\method{\green{rollback}}{setzt Zustand zurück auf den mit time()=$t$}{1}
	\end{methods}

	Laufzeiten sind amortisiert.

	\green{Mit rollback: find nur noch in O(log(n)).}
