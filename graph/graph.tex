...
\begin{algorithm}{Heavy-Light Decomposition} %TODO update doc (insb. Option edges(green) + move some comments here?), test
	\begin{methods}
...
\begin{algorithm}{Min-Cost-Max-Flow}
	\begin{methods}
		...
		\method[asume $\O(F (n+m) \log n)$]{run}{berechnet maximalen Fluss F mit minimalen Kosten}{\abs{V}\cdot\abs{E}\cdot F}
	\end{methods}
